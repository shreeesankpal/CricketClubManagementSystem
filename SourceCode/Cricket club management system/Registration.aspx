<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Cricket_club_management_system.Registration" %>
...
<body style="background-image:url('image/12.png') ;height: 200px;">
        ...
        <div class="container" style="width:50%; margin-top: 50px;">
            <div class="row" style="display: flex; justify-content: center;">
                <div class="col-12 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title" style="text-align: center; margin-bottom: 20px;">User Registration</h1>
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Last Name cannot be blank" ControlToValidate="lastname" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Password cannot be blank" ControlToValidate="password" ForeColor="Red"></asp:RequiredFieldValidator>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="password" ControlToValidate="txtConfirmPassword" ErrorMessage="Password and confiem password must be same" ForeColor="Red"></asp:CompareValidator>
                                </div>
                                <div class="mb-3">
                                    <asp:TextBox ID="txtConfirmPassword" CssClass="form-control" placeholder="Confirm Password" runat="server" TextMode="Password"></asp:TextBox>
                                </div>

                                <div class="d-grid" style="text-align: center;">
                                    <center><asp:Button ID="btnRegister" runat="server" Text="REGISTER" CssClass="btn btn-dark" Width="120px" OnClick="btnRegister_Click" />   </center>
                                </div>
                                 
                                <div class="text-center mt-3">
                                    <p>Already Register <a href="user login.aspx">Login here</a></p>
                                </div>
                            </asp:Panel>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <h5>QUICKLINKS</h5>
                        ...
                        <a href="home.html" class="text-white">Home</a><br>
                        <a href="About us.html" class="text-white">About</a><br>
                        <a href="Our team members.html" class="text-white">Our team</a><br>
