<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feedback.aspx.cs" Inherits="Cricket_club_management_system.Feedback" %>
...
<body style="background-image:url('image/16.png') ;">
...
<div class="container mt-5" style="width: 30%; background-color: #f2f2f2; padding: 20px; border-radius: 10px;">
    <h2 class="text-center">Cricket Club Feedback Form</h2>
    <form asp-action="SubmitFeedback" asp-controller="Feedback" method="post">
        <div class="mb-3">
            <label asp-for="FullName" class="form-label" style="margin-right:300px">Full Name</label>
            <input asp-for="FullName" class="form-control" placeholder="Enter your full name" required />
        </div>
        <div class="mb-3">
            <label asp-for="Email" class="form-label" style="margin-right:300px">Email address</label>
            <input asp-for="Email" class="form-control" placeholder="Enter your email" required />
        </div>
        <div class="mb-3">
            <label asp-for="Rating" class="form-label" style="margin-right:270px">Rate Our Club (1-5)</label>
        ...
        <div class="mb-3">
            <label asp-for="Feedback" class="form-label" style="margin-right:300px">Your Feedback</label>
            <textarea asp-for="Feedback" class="form-control" rows="4" placeholder="Write your feedback here" required></textarea>
        </div>
