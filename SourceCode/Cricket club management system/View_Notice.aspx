<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_Notice.aspx.cs" Inherits="Cricket_club_management_system.View_Notice" %>
 ...
    </div>
    ...
    <form id="form1" runat="server" style="margin-top:10px">
      ...
      <div class="blog-container" style="width:80%;">
          <h2 class="text-center mb-4">Notice Posts</h2>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptBlogs" runat="server">
                            <ItemTemplate>
                                <tr class='<%# Container.ItemIndex % 2 == 0 ? "table-light" : "table-light" %>'>
                                    <td><%# Eval("Title") %></td>
