<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Login.aspx.cs" Inherits="Cricket_club_management_system.Admin_Login" %>
...
<body style="background-image:url('image/18.png') ;">
...
<form id="loginForm" runat="server" class="d-flex justify-content-center align-items-center" style="margin-top:20px;">
    <div class="card shadow-lg p-4" style="width: 400px; border-radius: 10px;background-color:#f2f2f2; color: black;">
        <div class="card-body";>
            <h3 class="card-title text-center mb-3">Admin Login</h3>
            <div class="mb-3">
                <label for="txtUsername" class="form-label">Username:</label>
                <asp:TextBox ID="txtUsername" runat="server" CssClass="form-control" Style="border-radius: 5px; border: none; padding: 10px;" Required="true" />
            </div>
            <div class="mb-3">
                <label for="txtPassword" class="form-label">Password:</label>
                <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" TextMode="Password" Style="border-radius: 5px; border: none; padding: 10px;" Required="true" />
            </div>
            <div class="d-grid gap-2">
                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn" Style="color: white;background-color:black; font-weight: bold; border-radius: 5px; padding: 10px;" OnClick="btnLogin_Click" />
            </div>
            <div class="text-center mt-2">
                <asp:Label ID="lblErrorMessage" runat="server" ForeColor="Red" CssClass="text-danger" />
            </div>
        </div>
    </div>
</form>
